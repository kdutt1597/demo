...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <a href="<?php echo base_url('admin/projects');?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
 ...
 <div class="tab-content">
   <div id="tab-general" class="tab-pane active">
      <fieldset>
         ...
         <div class="row mb-3">
              <label for="input-username" class="col-sm-2 col-form-label">Thumbnail</label>
              <div class="col-sm-10">
                <?php if (!empty($image)): ?>
      ...
      <div class="row mb-3">
              <label for="input-username" class="col-sm-2 col-form-label">Banner Image</label>
              <div class="col-sm-10">
                <?php if (!empty($banner)): ?>
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-10">
                  <input type="text" name="slug" value="<?php echo set_value('slug',$slug); ?>" placeholder="slug"  class="form-control" />                
              </div>
          </div>
