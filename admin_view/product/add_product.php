...
<ul class="nav nav-tabs">
 ...
 <li class="nav-item"><a href="#tab-data" data-bs-toggle="tab" class="nav-link">Data</a></li>
  <li class="nav-item"><a href="#tab-feature" data-bs-toggle="tab" class="nav-link">Feature</a></li>
  <li class="nav-item"><a href="#tab-capabilities" data-bs-toggle="tab" class="nav-link">Capabilities</a></li>
   ...
   <div id="tab-general" class="tab-pane active">
      <fieldset>
          ...
          <div class="row mb-3 required">
              <label for="input-username" class="col-sm-2 col-form-label">Product Name</label>
              <div class="col-sm-10">
