...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <a href="<?php echo base_url('admin/services');?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
...
<div id="tab-data" class="tab-pane">
        <legend>Images</legend>
         ...
         <legend>Solution</legend>
          ...
          <!--<div class="row mb-3">-->
          <!--    <label for="input-email" class="col-sm-2 col-form-label">Offering</label>-->
          <!--    <div class="col-sm-10">       -->
