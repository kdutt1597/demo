...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                 <a href="<?php echo base_url('admin/add_sector'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_sectors','id="form-user"'); ?> 
                           ...
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                              ...
                              <td class="text-start"><?php echo $value->name; ?></td>
                               <td class="text-start"><img src="<?php echo $value->image?base_url($value->image):base_url($config_logo); ?>"></td>
                             
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_sector/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
