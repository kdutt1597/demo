...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_cloud_cats'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php echo base_url('admin/cloud_cats') ?>" method="get">
            <div class="mb-3">
            ...
            <div class="text-end">
              ...
              <a href="<?php echo base_url('admin/cloud_cats'); ?>"><button type="button" id="button-filter" class="btn btn-light"><i class="fa-solid fa-filter"></i> Reset</button></a>
            </div>
            </form>
          </div>
      ...
      <?php if ($error = session()->getFlashdata('error')): ?>
       ...
       <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_cloud_cats','id="form-user"'); ?>
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                            ...
                            <td class="text-start"><?php echo $value->sort_order; ?></td>
                             ...
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_cloud_cats/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
