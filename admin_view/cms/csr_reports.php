...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_csr_report'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
      ...
      <?php if ($error = session()->getFlashdata('error')): ?>
       ...
       <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_csr_reports','id="form-user"'); ?> 
                                 ...
                                 <td style="width: 1px;" class="text-start"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                                   ...
                                   <td class="text-start">Financial Year</td>
                                    <td class="text-start">Category</td>      
                                         <td class="text-start">Notice Category</td>  
         ...
         <?php foreach ($detail as $key => $value){  ?>
	         ...
	         <td class="text-left"><?php echo $value->category_name; ?></td>
	           <td class="text-left"><?php echo $value->notice_name; ?></td>
	         ...
	         <td class="text-right">
	          <a href="<?php echo base_url('admin/add_csr_report/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
