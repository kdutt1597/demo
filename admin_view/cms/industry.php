...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_industry'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_industry','id="form-user"'); ?> 
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                              ...
                              <td class="text-start">
                               ...
                               <video muted autoplay loop playsinline class="future_media" width="200" height="200">
                                ...
                                <?php }else{ ?>
                                     <img src="<?php echo base_url($value->thumbnail); ?>" width="100" height="100">
                                <?php } ?>
                            ...
                            <?php } ?>
                             ...
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_industry/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
