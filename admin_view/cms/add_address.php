    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/address'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                   ...
                   <div class="row mb-3 required">
                      ...
                      <div class="row mb-3 ">
                        <label for="input-name" class="col-sm-2 col-form-label">Address</label>
                        <div class="col-sm-10">
              ...
              <div class="col-sm-10">
                  ...
                  <input type="file" name="image" value="<?php echo set_value('image',$image); ?>" placeholder=""  class="form-control" />
                    ...
                    <div class="row mb-3 ">
                        <label for="input-name" class="col-sm-2 col-form-label">Google Map Link</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="map"><?php echo set_value('map',$map); ?></textarea>
                        </div>
                    </div>     
