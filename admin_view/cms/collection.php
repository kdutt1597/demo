...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_collection'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_collection','id="form-user"'); ?> 
                                 ...
                                 <td style="width: 1px;" class="text-start"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                                   ...
                                   <td class="text-start">State</td>
                                    <td class="text-start">Address 1 </td>
                                      <td class="text-start">Partner Name </td>
                                        <td class="text-start">B. Manager Name</td>
                            
                                  <td class="text-start">Branch Exits</td>
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                              ...
                              <td class="text-start"><?php echo $value->city; ?></td>
                              <td class="text-start"><?php echo $value->state; ?></td>
                             <td class="text-start"><?php echo $value->address1; ?></td>
                              <td class="text-start"><?php echo $value->partnerName; ?></td>
                               <td class="text-start"><?php echo $value->branchManagerName; ?></td>
                               
                      
                             <td class="text-start"><?php echo $value->branchExits==1?'Yes':'No'; ?></td>
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_collection/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
