...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                 <a href="<?php echo base_url('admin/add_cx_feature'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_cx_feature','id="form-user"'); ?> 
                        ...
                        <table class="table table-bordered table-hover">
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_cx_feature/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
