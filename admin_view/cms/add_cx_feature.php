...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <a href="<?php echo base_url('admin/cx_feature');?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
   ...
   <div id="tab-general" class="tab-pane active">
      <fieldset>
        <legend>Overview</legend>
          ...
          <!--    <div class="col-sm-10">-->
          <!--       <textarea name="shotDescription" class="form-control" rows="5"><?php echo set_value('shotDescription',$shotDescription); ?></textarea>-->
