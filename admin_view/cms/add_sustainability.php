...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <a href="<?php echo base_url('admin/sustainability');?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
...
<ul class="nav nav-tabs">
  <li class="nav-item"><a href="#tab-general" data-bs-toggle="tab" class="nav-link active">General</a></li>
   ...
   <li class="nav-item"><a href="#tab-feature" data-bs-toggle="tab" class="nav-link">Pillar</a></li>
...
<div class="table-responsive">
        <table id="images" class="table table-striped table-bordered table-hover">
         ...
         <tbody>
         <?php if (!empty($pillarList)){ foreach ($pillarList as $key => $row) {?>
         ...
         <tr id="image-row<?php  echo $row->id; ?>">  
           ...
           <td class="text-left"><input type="text" name="featureDescription[]" value="<?php echo $row->description; ?>"  placeholder="Title" class="form-control" /></td>
...
<script type="text/javascript">
  var feature = 0;
   ...
   html += '  <td class="text-left"><input type="text" name="featureDescription[]"  placeholder="" class="form-control " /></td>';
