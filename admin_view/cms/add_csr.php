    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/csr'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div class="row mb-3 required">
              <label for="input-username" class="col-sm-2 col-form-label">Select Type</label>
              <div class="col-sm-10">
                 <select name="type" class="form-control" id="projectId">
                   <option value="">Select</option>
                   <?php foreach ($typeList as $key => $value): ?>
                     <option value="<?php echo $key;  ?>" <?php echo $key==$type?'selected':''; ?>><?php echo $value; ?></option>
                   <?php endforeach ?>
                 </select>
                    <?php echo $validation->hasError('type')?$validation->showError('type','my_single'):''; ?>
               </div>
          </div>
              ...
              <div class="col-sm-10">
                  ...
                  <input type="file" name="image"  placeholder=""  class="form-control" />
                      ...
                      <div class="row mb-3 ">
                        <label for="input-name" class="col-sm-2 col-form-label">is Small Section</label>
                        <div class="col-sm-10">                           
                            <input type="checkbox" name="small" value="1"   <?php echo $small==1?'checked':'';?> />
