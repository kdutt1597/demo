...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_investor_category'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
      ...
      <?php if ($error = session()->getFlashdata('error')): ?>
       ...
       <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_investor_category','id="form-user"'); ?> 
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                            ...
                            <td class="text-start"><?php echo $value->name; ?></td>
                             ...
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_investor_category/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
