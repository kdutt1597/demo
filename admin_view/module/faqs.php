...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_faq'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_faq','id="form-user"'); ?> 
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                              ...
                              <td class="text-start"><?php echo $value->question; ?></td>
                              <td class="text-start"><?php echo $value->answer; ?></td>
                             <td class="text-start"><?php echo $value->sort_order; ?></td>
                      
                             <td class="text-start"><?php echo $value->status==1?'Active':'Deactive'; ?></td>
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_faq/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
