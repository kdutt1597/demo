    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/awards'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                    ...
                    <div class="row mb-3 required">
                     ...
                     <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Select</label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3 ">
                        <label for="input-name" class="col-sm-2 col-form-label">Patent No.</label>
                        <div class="col-sm-10">
                            <input type="text" name="patentNumber" value="<?php echo set_value('patentNumber',$patentNumber); ?>" placeholder="patent Number"  class="form-control" />
                      ...
                      <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Award/patent Image</label>
                        <div class="col-sm-10">
                            <?php if (!empty($image)): ?>
...
<!-- 
                     <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Award Pdf</label>
                        <div class="col-sm-10">
                             <?php if (!empty($pdf)): ?>
                            <a href="<?php echo base_url($pdf); ?>" target="_blank">  <i class="fa fa-file-pdf fa-2x"></i></a> 
                            <?php endif ?>
               ...
               <!--     <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Publish Date</label>
                        <div class="col-sm-10">
                            <input type="text" name="publish" value="<?php echo set_value('publish',$publish); ?>" placeholder=""  class="form-control" />
                        </div>
                    </div>
 -->
