        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <select name="type" class="form-control">
                ...
                <?php foreach ($typeList as $key => $value): ?>
                       <option value="<?php echo $value->type;  ?>" <?php echo @$_GET['type']==$value->type?'selected':''; ?>  ><?php echo $value->type; ?></option>
                <?php endforeach ?>
              </select>
            ...
            <div class="text-end">
              ...
              <a href="<?php echo base_url('admin/blog_enquiry'); ?>"><button type="button" id="button-filter" class="btn btn-light"><i class="fa-solid fa-filter"></i> Reset</button></a>
            </div>
            </form>
          </div>
  ...
  .list-group-item{
    ...
    font-weight: 600;
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_blog_enquiry','id="form-user"'); ?> 
