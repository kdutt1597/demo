    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/faqs'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                    ...
                    <div class="row mb-3 required">
                        <label for="input-name" class="col-sm-2 col-form-label">Question</label>
                        <div class="col-sm-10">
                            <input type="text" name="question" value="<?php echo set_value('question',$question); ?>" placeholder="question"  class="form-control" />

                          <?php echo $validation->hasError('question')?$validation->showError('question','my_single'):''; ?>
                        </div>
                    </div>

     
                    <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Answer</label>
                        <div class="col-sm-10">
                           <textarea name="answer" class="form-control" rows="5"><?php echo set_value('answer',$answer); ?></textarea>
                        </div>
                    </div>
