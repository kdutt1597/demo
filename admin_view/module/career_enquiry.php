    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_career_enquiry','id="form-user"'); ?> 
                                ...
                                <tr>
                                 <td style="width: 1px;" class="text-start"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                                    ...
                                    <td class="text-start">Name</td>
                                     ...
                                     <td class="text-start">Resume</td>
                                     <td class="text-start">Job</td>
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                            ...
                            <td class="text-start"><?php echo $key+1; ?></td>
                             <td class="text-start"><?php echo $value->first_name.' '.$value->last_name; ?></td>
                              ...
                              <?php endif ?>
                                     ...
                                     <td class="text-start"><?php echo $value->career_name; ?></td>
