    ...
    <div class="container-fluid">
      ...
      <?php endif ?>
            ...
            <div id="user" class="card-body">
               <?php echo form_open('admin/delete_pages','id="form-user"'); ?> 
                    <div class="table-responsive">
                          ...
                          <?php if(!empty($detail)){
                           foreach ($detail as $key => $value){?>
                             ...
                             <td class="text-start"><input type="checkbox" name="selected[]" value="<?php echo $value->id; ?>" /></td>
                              ...
                              <td class="text-start"><?php echo $value->slug; ?></td>
                        ...
                        <!--<td class="text-start"><?php echo $value->type; ?></td>-->
                             ...
                             <td class="text-start">
                              <a href="<?php echo base_url('admin/add_pages/'.$value->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
