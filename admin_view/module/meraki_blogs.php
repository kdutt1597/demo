...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
               <a href="<?php echo base_url('admin/add_meraki_blog'); ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a> &nbsp;
    ...
    <div class="container-fluid">
       <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php echo base_url('admin/meraki_blogs') ?>" method="get">
            <div class="mb-3">
            ...
            <div class="text-end">
              ...
              <a href="<?php echo base_url('admin/meraki_blogs'); ?>"><button type="button" id="button-filter" class="btn btn-light"><i class="fa-solid fa-filter"></i> Reset</button></a>
            </div>
            </form>
          </div>
                          ...
                          <?php if (!empty($groupedBlogs)) { 
                            foreach ($groupedBlogs as $blogId => $blog) { 
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <a href="<?php echo base_url('admin/add_meraki_blog/' . $blogData->id); ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary">
