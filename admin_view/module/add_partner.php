    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/partners'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
      ...
      <?php endif ?>
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                    ...
                    <div class="row mb-3">
                        <label for="input-name" class="col-sm-2 col-form-label">Select Partner Tag</label>
                        <div class="col-sm-10">
                           <select name="tag_id" class="form-control" id="tag_id">
                             <option value="">Select</option>
                             <?php foreach ($tagList as $key => $value): ?>
                               <option value="<?php echo $value->id; ?>" <?php echo $tag_id==$value->id?'selected':''; ?>><?php echo $value->type.' > '.$value->name; ?></option>
                             <?php endforeach ?>
                           </select>
