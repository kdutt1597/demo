    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                ...
                <a href="<?php echo base_url('admin/author'); ?>" data-bs-toggle="tooltip" title="Back" class="btn btn-light">
            ...
            <div class="card-body">
                 ...
                 <form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="designation" value="<?php echo set_value('designation',$designation); ?>" placeholder="name"  class="form-control" />                         
                        </div>
                    </div>
                      ...
                      <div class="row mb-3 ">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="5" name="description"  class="form-control"><?php echo set_value('description',$description); ?></textarea>
